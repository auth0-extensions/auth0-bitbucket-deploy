...
export default () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//6fb7e13e.ngrok.io/app/auth0-bitbucket-deploy.ui.<%= assets.version %>.css"><% } %>
  </head>
  <body class="a0-extension">
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//6fb7e13e.ngrok.io/app/auth0-bitbucket-deploy.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//6fb7e13e.ngrok.io/app/auth0-bitbucket-deploy.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
